package com.chaehyeon.blog_project.config;

import com.chaehyeon.blog_project.config.auth.PrincipalDetailService;
...
@EnableWebSecurity // 시큐리티 필터가 등록 = 스프링 시큐리티가 활성화가 되어있는데 어떤 설정을 해당 파일에서 하겠다.
